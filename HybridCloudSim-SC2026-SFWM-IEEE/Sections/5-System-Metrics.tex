...
\end{equation}
\endgroup
where $c(d)$ denotes the resource unit capacity of device $d$ (qubits for a QPU, CPU units for a classical node), and $b(d)$ represents the associated memory bandwidth capacity.
